...
///////////////////////////////////////////////////////////////////////////
    ...
    $address = "info@lmcincorporated.com";
...
// Please Note, we cannot support this file package if modifications have been made below this line.
	...
	$error = '';
		...
		if(get_magic_quotes_gpc()) { $comments = stripslashes($comments); }
         ...
         $e_subject = 'You\'ve been contacted by ' . $name . 'via the LMC Website.';

         // Advanced Configuration Option.
		 // You can change this if you feel that you need to.
		 // Developers, you may wish to add more fields to the form, in which case you must be sure to add them here.
					
		 $msg  = "You have been contacted by $name, they passed verification and their message is as follows.\r\n\n";
		 $msg .= "$comments\r\n\n";
